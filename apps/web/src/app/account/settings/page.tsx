  ...
  return (
    <div>
      <PageHeader
        eyebrow="Preferences"
        title="Settings"
        description="Manage language, timezone, profile visibility, and account contact preferences."
      />
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <SurfaceCard title="Account preferences" subtitle="Identity and privacy controls">
        ...
        <SurfaceCard title="Related account controls" subtitle="Security and communication areas">
          <div className="space-y-2 text-sm">
            ...
            <Link href="/account/security" className="block rounded-xl border border-night-700 px-3 py-2 text-sand-100 hover:border-night-600">
              Security controls
            </Link>
            <Link href="/account/password" className="block rounded-xl border border-night-700 px-3 py-2 text-sand-100 hover:border-night-600">
              Change password
            </Link>
          </div>
        </SurfaceCard>
