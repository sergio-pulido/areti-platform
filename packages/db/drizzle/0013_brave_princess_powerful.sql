...
CREATE UNIQUE INDEX `chat_thread_branches_thread_id_unique` ON `chat_thread_branches` (`thread_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `chat_thread_branches_source_thread_source_message_unique` ON `chat_thread_branches` (`source_thread_id`,`source_message_id`,`thread_id`);
