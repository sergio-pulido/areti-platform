...
const highlights = [
  "Secure account system with hashed passwords and hardened server sessions",
  "Role-ready dashboard architecture with side navigation and quick actions",
  "Integrated AI companion for practical philosophical coaching",
  "Structured practices, journaling, library, community, and account settings",
];
      ...
      <div className="relative overflow-hidden">
        ...
        <main className="relative z-10 mx-auto max-w-7xl px-6 pb-16 pt-6 lg:px-12 lg:pb-24 lg:pt-10">
          <section className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:gap-10">
            ...
            <div className="rounded-3xl border border-night-800 bg-night-900/60 p-6 shadow-2xl shadow-black/30">
              ...
              <div className="mt-5 space-y-3">
                {pillars.map((pillar) => (
                  <article key={pillar.title} className="rounded-2xl border border-night-700/80 bg-night-950/70 p-4">
          ...
          <section className="mt-12 grid gap-3 md:grid-cols-2">
            {highlights.map((item) => (
              <div key={item} className="rounded-2xl border border-night-800 bg-night-900/50 p-4 text-sm text-sand-200">
                {item}
              </div>
            ))}
          </section>
